...
created.innerHTML='Aplicacion creada por Vic' 
...
function buildToDo(todo, index) {
  ...
  return toDoShell                                                         //?8
  //*<div class='toDoShell'><span id='index'>todo.description</span></div>
  
  // toDoText.removeAttribute('id')
  // checkbox.id=index
  // checkbox.addEventListener('click',()=>this.complete=true)
  // toDoText.removeEventListener('click');
...
function addToDo() {
  ...
  if(toDoInput.value ===''){
    ...
    return emptyBox.classList.add('d-block')
  }
